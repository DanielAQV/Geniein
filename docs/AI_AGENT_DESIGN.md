...
**"한 명처럼 느껴지는 것"은 UX 취향이 아니라 제품 요구사항이다.** 유나는 지니인의 브랜드 자산이고, 장기적으로 Connext 고객사에 함께 나간다. 인격 일관성이 흔들리면 브랜드가 흔들린다. `PERSONA.md` 사업축 3번(AI & Intelligent Engineering)과 4장의 `org_id` 헤지가 여기서 만난다.
