...
function BusinessNavContent() {
  const { t } = useLanguage()
  const activeTab = useCategory() === "oda" ? "oda" : "platform"
  ...
  return (
    <div className="sticky top-[61px] z-40 w-full border-b border-border bg-card/60 backdrop-blur-xl shadow-[0_4px_20px_-10px_rgba(0,0,0,0.1)]">
