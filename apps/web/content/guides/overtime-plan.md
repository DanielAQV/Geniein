...
order: 6
supersedes: Overtime(OT) Plan Approval_User Guide_Requester_19Jan.pdf (19 Jan 2026)
---

## Before you start

Register overtime here **before** the work happens. The payment request for that overtime is submitted afterwards and refers back to this plan.

- Approvals run one after another, in the order you list the approvers.
- One plan can cover several people — list them all under Staff.

## Submitting

### Step 1 — Fill in the form

In the Overtime Plan list, click **+ Add new item**.
...
| Site Details | The site, when `Others` needs explaining. |
