---
title: Annual Leave
summary: How to request leave, and what happens after it is approved.
roles: [requester, approver]
order: 5
updated: 2026-08-27
supersedes: Requester_Guide_19Jan.pdf (19 Jan 2026)
---

## Before you start

Use this form for any absence — annual leave, sick leave, unpaid leave, maternity leave, or working from home.

- Approvals run one after another, in the order you list the approvers.
- Half days are set with the start and end type, not by changing the dates.

## Submitting

### Step 1 — Fill in the form

In the Annual Leave list, click **+ Add new item**.
...
| Leave days | How many days this adds up to. |
...
The request is marked Approved, an approval document is filed automatically, and you receive a confirmation email.
