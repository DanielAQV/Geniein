...
One plan covers one month for one team. Each budget item is a line inside the plan.
...
In the Budget Planning list, click **+ Add new item**.

| Field | What to enter |
|---|---|
| Title | A name for this plan. |
| Month | The month the budget is for. |
...
### Step 2 — Add the budget lines

Add one line per item and fill in every column.

| Column | What to enter |
|---|---|
| Category | What the spending is for. |
| Description | The detail behind the number. |
| Currency · Amount · EXR | The amount, and the exchange rate used. |
| VND Amount | The converted amount. |
...
The plan and its lines are marked Approved, an approval document is filed automatically, and you receive a confirmation email.
